...
namespace KanDic.Resources
{
    public class TabNum
    {
        ...
        public TabNum(string group, string team, Kan[] yyy)
        {
            ...
            if (yyy[Number[0]] != null) Image1 = "/Cache/ships/" + yyy[Number[0]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image1 = "/Cache/error.png";
            if (yyy[Number[1]] != null) Image2 = "/Cache/ships/" + yyy[Number[1]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image2 = "/Cache/error.png";
            if (yyy[Number[2]] != null) Image3 = "/Cache/ships/" + yyy[Number[2]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image3 = "/Cache/error.png";
            if (yyy[Number[3]] != null) Image4 = "/Cache/ships/" + yyy[Number[3]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image4 = "/Cache/error.png";
            if (yyy[Number[4]] != null) Image5 = "/Cache/ships/" + yyy[Number[4]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image5 = "/Cache/error.png";
            if (yyy[Number[5]] != null) Image6 = "/Cache/ships/" + yyy[Number[5]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image6 = "/Cache/error.png";
            if (yyy[Number[6]] != null) Image7 = "/Cache/ships/" + yyy[Number[6]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image7 = "/Cache/error.png";
            if (yyy[Number[7]] != null) Image8 = "/Cache/ships/" + yyy[Number[7]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image8 = "/Cache/error.png";
            if (yyy[Number[8]] != null) Image9 = "/Cache/ships/" + yyy[Number[8]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
            else Image9 = "/Cache/error.png";
            if (yyy[Number[9]] != null) Image10 = "/Cache/ships/" + yyy[Number[9]].BasicInfo.FileName + ".swf/Images/Image 5.jpg";
